...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/06/01 20:38:11 by aceralin          #+#    #+#              #
#    Updated: 2022/06/02 18:33:39 by aceralin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			=	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
					...
					ft_strjoin.c ft_strtrim.c ft_split.c ft_putchar_fd.c ft_putstr_fd.c ft_putnbr_fd.c\
					ft_putendl_fd.c ft_strmapi.c ft_striteri.c ft_itoa.c\
